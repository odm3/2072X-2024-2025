...
//declares drive motors with specified ports and gearsets
...
//declares mechanism motors with specified ports and gearsets
...
//declares smart wire sensors with their ports
...
//declares three wire port devices with ports and init states
...
pros::adi::DigitalOut pistonDoinker(PORT_PISTON_DOINKER, false);
...
//declares LemLibChassis configs

//declares left motor groups with motors and gearsets
pros::MotorGroup left_chassis({ PORT_MOTOR_LF, PORT_MOTOR_LM, PORT_MOTOR_LB }, pros::MotorGearset::blue);
//declares right motor groups with motor ports and gearsets
pros::MotorGroup right_chassis({ PORT_MOTOR_RF, PORT_MOTOR_RM, PORT_MOTOR_RB }, pros::MotorGearset::blue); 

//declares Lemlib Chassis prerequisites

//declares lemlib drivetrain with motorgroups, track width, wheel diameter, wheel rpm, and drift
...
//declares a lemlib odom sensors class
...
//declares lateral drive PID controllers
...
//declares angular drive PID controller 
